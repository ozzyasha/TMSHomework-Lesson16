...
class ViewController: UIViewController {
    ...
    let longPressCirle = UILongPressGestureRecognizer()
    ...
    func setupCircle() {
        ...
        gesture.addTarget(self, action: #selector(circleTapped))
        longPressCirle.addTarget(self, action: #selector(circleLongPressed))
        circleView.addGestureRecognizer(gesture)
        circleView.addGestureRecognizer(longPressCirle)
    }
